...
const Map = forwardRef<MapRef, MapProps>(function Map(
  ...
  return (
    <MapContext.Provider value={contextValue}>
      ...
      >
        {hasError ? (
          <div className="absolute inset-0 flex items-center justify-center rounded-2xl border border-border/60 bg-muted/40 text-sm text-muted-foreground">
            Map unavailable (WebGL disabled).
          </div>
        ) : (
